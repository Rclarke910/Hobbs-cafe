            ...
            <div className='special__category'>
                <div className='special__group'>
                    <div className='special__img__border'>
                        <img src='src/assets/coffee-beans.png' alt='' className='special__img'></img>
                    </div>
                ...
                <div className='special__group'>
                    <div className='special__img__border'>
                        <img src='src/assets/hot-drink.png' alt='' className='special__img' ></img>
                    </div>
                ...
                <div className='special__group'>
                    <div className='special__img__border'>
                        <img src='src/assets/coffee-cup.png' alt='coffee' className='special__img' ></img>
                    </div>
